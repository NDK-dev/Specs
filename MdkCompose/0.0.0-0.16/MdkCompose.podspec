Pod::Spec.new do |spec|
    spec.name                     = 'MdkCompose'
    spec.version                  = '0.0.0-0.16'
    spec.homepage                 = 'https://messay.ndk-group.co.jp/en/sdk/'
    spec.source                   = { :http=> 'https://developer.messay.ndk-group.co.jp/cocoapods/mdk-compose-0.0.0-alpha16.tar.gz'}
    ...
    spec.vendored_frameworks      = 'MdkCompose.xcframework'
    spec.libraries                = 'c++'
